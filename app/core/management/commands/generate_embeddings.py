    ...
    def handle(self, *args, **options):
        ...
        for job_posting in job_postings:
            if job_posting.embedding is not None:
                self.stdout.write(f'Embedding already exists for job: {job_posting.title}, skipping.')
                continue
        ...
        self.stdout.write(self.style.SUCCESS('Successfully generated embeddings for all job postings.'))
